  ...
  function patchSummary(){
    ...
    window.buildSummary=function(){
      ...
      if(row){
        ...
        row.purchaseNote="Whole skinless bellies commonly run about 8–10 lb. If the package is larger than needed, portion and freeze the excess for a future cook.";
