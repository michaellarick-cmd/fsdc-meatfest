export default {
  async fetch(request, env) {
    ...
    if (type.includes("text/html")) {
      ...
      const injected = ["meatfest-additions.js","porkbelly-fix.js","protein-order-fix.js","side-order-fix.js","recommendation-fix.js","meatfest-calculation-lock.js","prime-rib-fix.js","meatfest-calculation-fix.js","meatfest-render-repair.js","meatfest-final.js"];
      ...
      const scripts = [
        ...
        '<script>\n'
          ...
          + '    meats.chicken.options.whole.unitWeight = 4.5;\n'
          + '    meats.chicken.options.whole.note = "Meatfest planning unit: about 4.5 lb per whole fryer.";\n'
          + '    meats.prime.options = {\n'
        ...
        '<script src="/meatfest-final.js?v=2"></script>',
      ].join("");
